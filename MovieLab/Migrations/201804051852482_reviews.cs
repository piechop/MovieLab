                ...
                c => new
                    {
                        ...
                        ReviewText = c.String(),
                        MovieRating = c.Byte(nullable: false),
                        ReviewRating = c.Byte(nullable: false),
                ...
                c => new
                    {
                        ...
                        FavoriteMovie_ID = c.Int(),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Movies", t => t.FavoriteMovie_ID)
                .Index(t => t.UserName, unique: true, name: "UserNameIndex")
                .Index(t => t.FavoriteMovie_ID);
